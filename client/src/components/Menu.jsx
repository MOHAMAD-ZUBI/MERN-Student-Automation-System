...
const Menu = () => {
  ...
  return (
    <div className="menu bg-[#1F3D75] flex flex-col justify-start sm:justify-center items-center gap-10 fixed w-full sm:w-[330px] h-screen z-40 pt-[52px] pb-[67px] px-[56px] top-0 -left-full duration-0.3 ">
      <span
        className="close-menu absolute w-5 top-[22px] left-[25px] sm:left-[40px] cursor-pointer scale-75"
        onClick={closeMenu}
      >
        <Close></Close>
      </span>
