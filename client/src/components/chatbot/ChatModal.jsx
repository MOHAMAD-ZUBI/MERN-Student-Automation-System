...
function ChatBox() {
  ...
  const toggleChatbox = () => {
   ...
   // setChatMessages([]);
    ...
    addBotMessageWithDelay("AI: Please choose a topic to start your conversation.", 2000);
    
  };
  
  const addBotMessageWithDelay = (message, delay) => {
    setTimeout(() => {
      setChatMessages(prevMessages => [...prevMessages, { message, isUser: false }]);
    }, delay);
  };
